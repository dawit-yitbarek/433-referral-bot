  ...
  return (
    <div className="min-h-screen bg-black text-white px-4 pb-20 pt-8 font-poppins">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {searchError && (
          <p
            className={`${searchError !== "No user found with this username." && "text-red-400"} mt-3`}
          >
            {searchError}
          </p>
        )}
      ...
      {searchResults.length === 0 && !searching && !searchError && (
        <div className="max-w-4xl mx-auto mt-6">
          ...
          {users.length === 0 && !loading && !userError && (
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-[#CBA6F7]">
                Referrals of {selectedUser?.name}
              </h2>
              <button
                onClick={() => setModalOpen(false)}
            ...
            <div className="flex flex-col gap-3 max-h-[60vh] overflow-y-auto pr-2">
              {refLoading && (
                <p className="text-center text-[#808080]">
                  Loading referrals{".".repeat(dotCount)}
                </p>
              )}
              {!refLoading && refError && (
                <div className="text-center text-red-400">
                  ...
                  <button
                    onClick={() =>
                      loadReferrals(selectedUser.telegram_id, selectedUser)
                    }
